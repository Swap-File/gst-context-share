...
#Gstreamer stuff
LDFLAGS = -L/usr/local/lib -lX11 -lXrender -lGL -lGLU -lglut  -lpng  -lgstapp-1.0 -lgstvideo-1.0 -lgstgl-1.0 -lgstreamer-1.0 -lgmodule-2.0 -lgthread-2.0 -lgobject-2.0 -lglib-2.0 -lwiringPi  -lm
